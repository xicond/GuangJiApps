...
func (s *TopicService) List() []domain.Resource {
...
func (s *TopicService) Create(payload domain.Resource) (domain.Resource, error) {
...
func (s *TopicService) Get(id string) (domain.Resource, error) {
	var item domain.Resource
	if err := s.db.First(&item, "id = ?", id).Error; err != nil {
		return domain.Resource{}, fmt.Errorf("topic %s not found", id)
	}
	return item, nil
}

func (s *TopicService) Update(id string, payload domain.Resource) (domain.Resource, error) {
	var item domain.Resource
	if err := s.db.First(&item, "id = ?", id).Error; err != nil {
		return domain.Resource{}, fmt.Errorf("topic %s not found", id)
	}
