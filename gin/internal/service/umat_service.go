...
func (s *UmatService) List() []domain.Resource {
...
func (s *UmatService) Create(payload domain.Resource) (domain.Resource, error) {
...
func (s *UmatService) Get(id string) (domain.Resource, error) {
	var item domain.Resource
	if err := s.db.First(&item, "id = ?", id).Error; err != nil {
		return domain.Resource{}, fmt.Errorf("umat %s not found", id)
	}
	return item, nil
}

func (s *UmatService) Update(id string, payload domain.Resource) (domain.Resource, error) {
	var item domain.Resource
	if err := s.db.First(&item, "id = ?", id).Error; err != nil {
		return domain.Resource{}, fmt.Errorf("umat %s not found", id)
	}
