  ...
  <div class="view-container">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Kelola daftar data sxy donatur, pencarian, serta manajemen data</p>
      </div>
      <el-button
        type="primary"
        size="large"
    ...
    <el-card shadow="never" class="table-card">
      ...
      >
        ...
        <el-table-column prop="nama" label="Nama Sxy Donatur" min-width="180">
...
function handleCreate() {
  ElNotification({
    title: 'Informasi',
    message: 'Tambah sxy donatur baru',
    type: 'info'
  })
}
...
function handleEdit(id: number | string) {
  ElNotification({
    title: 'Informasi',
    message: `Edit sxy donatur ID: ${id}`,
    type: 'info'
  })
}
...
async function handleDelete(id: number | string) {
  try {
    ElNotification({
      title: 'Berhasil',
      message: `Data sxy donatur ID: ${id} berhasil dihapus`,
      type: 'success'
    })
    fetchData()
  } catch (err: any) {
