        ...
        <el-table-column label="Aksi" width="190" align="center" :fixed="!isDesktop ? false : 'right'">
          <template #default="{ row }">
            <div class="action-buttons">
              <el-button type="info" size="small" circle :icon="View" title="Lihat Detail Kelas & Peserta"
              ...
              <el-popconfirm title="Apakah Anda yakin ingin menghapus data ini?" confirm-button-text="Ya, Hapus"
                cancel-button-text="Batal" confirm-button-type="danger" @confirm="handleDelete(row.trx_id)">
                <template #reference>
